...
targetpc = '6285246217522' // Fitnah Target ( HAIKAL )
owner = '6285246217522' // Numbers Owner ( HW MODS WA )
ownerNumbers = ["6285246217522@s.whatsapp.net","6285246217522@s.whatsapp.net","6285246217522@s.whatsapp.net"]
...
fake = 'HW MODS WA & 卍JERRY KUNク' // Fake Text Reply / Name Bot ( HW MODS WA )
...
//=================================================//
if (budy.startsWith('Hw')){
if (isBan) return reply(mess.ban)
res = await Haikal.prepareMessageFromContent(from,{
"audioMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AqKLWyirKWDiGF9lTdwfIZOp1ykK-TmBAGVOnCD_LC-O.enc",
						"mimetype": "audio/mp4",
						"fileSha256": "1IB2WRCT8y9WEkJepRYQj2lxmLnPS+0egUltiHl/QHk=",
						"fileLength": "3033954",
						"seconds": 11,
						"ptt": true,
						"mediaKey": "Y9YkOBhwLvwdZr+pk2FuqTBFgj6d7QyPEwMj5FRkWao=",
						"fileEncSha256": "fDyffAizESCvPIj24m21EYSkm/OyKO/r+mZE91BluuQ=",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
